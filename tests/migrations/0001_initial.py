    ...
    operations += [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chef', models.ForeignKey(to='tests.Chef', on_delete=models.CASCADE, related_name='invented_pizzas')),
                ('critic', models.ForeignKey(to='tests.Chef', null=True, on_delete=models.CASCADE, related_name='reviewed_pizzas')),
